...
fold_rmse$fold1 <- sqrt((fold1$ltd_d11_f1 - fold1$ltd_d11)^2)
...
fold_rmse$fold2 <- sqrt((fold2$ltd_d11 - fold2$ltd_d11_f2)^2)
...
fold_rmse$fold3 <- sqrt((fold3$ltd_d11 - fold3$ltd_d11_f3)^2)
...
fold_rmse$fold4 <- sqrt((fold4$ltd_d11 - fold4$ltd_d11_f4)^2)
...
fold_rmse$fold5 <- sqrt((fold5$ltd_d11 - fold5$ltd_d11_f5)^2)
...
fold_rmse$fold6 <- sqrt((fold6$ltd_d11 - fold6$ltd_d11_f6)^2)
...
fold_rmse$fold7 <- sqrt((fold7$ltd_d11 - fold7$ltd_d11_f7)^2)
...
fold_rmse$fold8 <- sqrt((fold8$ltd_d11 - fold8$ltd_d11_f8)^2)
...
fold_rmse$fold9 <- sqrt((fold9$ltd_d11 - fold9$ltd_d11_f9)^2)
...
fold_rmse$fold10 <- sqrt((fold10$ltd_d11 - fold10$ltd_d11_f10)^2)


fold_rmse$average_rmse <- rowMeans(fold_rmse[, 2:11])
